...
int main(int argc, char* args[])
{
    ...
    gl->addGameObject(std::make_unique<GameObject>(Vec2 {0.f, 650.f}, 1280, 400, Color::ColorName::GREEN, true));
    //gl->addMovableGameObject(std::make_shared<MovableGameObject>(60, 60, 15, 15, Color::ColorName::WHITE, true, 0.f, 0.f, 8.f, 8.f));
    gl->setPlayer(std::make_shared<PlayerGameObject>(Vec2 {100.f, 100.f}, 50, 50, Color::ColorName::BLUE, true, 0.f, 0.f, 0.f, 50.f, g->getInput()));
